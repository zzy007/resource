...
<div class="toploginleft" id="toplogin">
  ...
  <body>
     <s:form action="resource/resource_editResource">
       <h1>修改资源</h1>
       <s:hidden name="resource.resourcename"></s:hidden>
       <s:textfield name="resource.resourcename" label="资源名称"></s:textfield>
       <s:textfield name="resource.keyword" label="关键词"></s:textfield>
       <s:textfield name="resource.description" label="描述"></s:textfield>
