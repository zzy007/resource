		       ...
		       <div class="panel panel-success">
		           ...
		           <div class="panel-body">
				       <div class="form-group">
			                ...
			                <div class="col-md-4">
                              <input type="text" name="res.resname" class="form-control input-sm" required>
                           </div>
			           </div>  
			           <div class="form-group">
			                <label class="control-label col-md-3">资源关键词</label>
			                <div class="col-md-2">
                              <input type="text" name="res.keyword" class="form-control input-sm" placeholder="&yen;" required>
                            </div>
			           </div>
			           <div class="form-group">
			                ...
			                <div class="col-md-4">
                              <div class="fileupload fileupload-new" data-provides="fileupload">
                                ...
                                <div>
                                   ...
                                   <span class="fileupload-exists">浏览</span><input type="file" name="resPhoto"/></span>
